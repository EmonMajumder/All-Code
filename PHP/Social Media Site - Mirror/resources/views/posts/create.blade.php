                    ...
                    <div class="card-body">
                        <form method="POST" action="{{'/posts'}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="image_url" type="text" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image_url" required>
